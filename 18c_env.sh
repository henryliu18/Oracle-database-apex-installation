...
if [ $this_id -ne 0 ]; then
  ...
  echo "unzip check..........[`command -v unzip>/dev/null;echo $?`]"
  echo "tar check..........[`command -v tar>/dev/null;echo $?`]"
  echo "yum check..........[`command -v yum>/dev/null;echo $?`]"
  echo "Oracle DB software check..........[`ls ${ORACLE_SW}>/dev/null;echo $?`]"
  echo "APEX software check..........[`ls ${APEX_SW}>/dev/null;echo $?`]"
  echo "ORDS software check..........[`ls ${ORDS_SW}>/dev/null;echo $?`]"
  echo "Internet check..........[`ping -q -c 1 -W 1 www.google.com>/dev/null;echo $?`]"
