...
read -p "Database hostname [192.168.56.102]: " ORACLE_HOSTNAME
ORACLE_HOSTNAME=${ORACLE_HOSTNAME:-192.168.56.102}

read -p "Database port [1521]: " ORACLE_PORT
ORACLE_PORT=${ORACLE_PORT:-1521}

read -p "Database name [pdb1]: " PDB
PDB=${PDB:-pdb1}
